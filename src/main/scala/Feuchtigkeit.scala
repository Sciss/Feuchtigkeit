...
//         linlin( i, 0, 1, 5, 1 )
      ...
      waterContainer( 2, spans, timeFun, _.energy )
   }
...
//         linlin( i, 0, 1, 5, 1 )
      ...
      waterContainer( 3, spans, timeFun, ch => -(ch.energy) )
   }

   def waterContainer[B]( containerIdx: Int, spans: Vector[ (Int, Int) ], timeFun: Double => Double,
      sortFun: Chunk => B )( implicit ord: Ordering[B] ) {
...
//         println( res )
      ...
      val chunksS = chunks.sortBy( sortFun )
